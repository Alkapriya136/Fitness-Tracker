      ...
      <form onSubmit={handleSubmit} className="login-form">
        ...
        <div className="mt-4">
            ...
            <div className="relative mt-2">
                ...
                <input onChange={(e)=> setPassword(e.target.value)} value={password}  placeholder="Please enter your password"  className="login-input pr-10" required type={showPassword ? 'text' : 'password'}/>
